...
class taskSerializer(DynamicFieldsMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = task
        fields = ['id', 'title', 'description', 'assignee', 'due_date', 'comments', 'case_id', 'case_name', 'folder_id',
                  'task_status', 'created_by', 'created_at', 'modified_by', 'modified_at']
...
class hearingSerializer(DynamicFieldsMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = hearing
        fields = ['id', 'name', 'hearing_date', 'latest', 'assignee', 'court', 'comments_by_lawyer', 'case_id',
                  'folder_id', 'folder_name', 'hearing_status', 'case_name', 'created_by', 'created_at', 'modified_by',
                  'modified_at']
        extra_kwargs = {'created_by': {'required': False}, 'modified_by': {'required': False}}
