...
class hearingViewSet(viewsets.ModelViewSet):
    ...
    def create(self,request):
        ...
        if not req_case_id in ('',None):
            case = get_object_or_404(LitigationCases,pk=req_case_id)
            hearings = hearing(id=None,latest=True,court=req_court,hearing_status=h_status,name=req_name,case_id=req_case_id,hearing_date=req_hearing_date,comments_by_lawyer=req_comments_by_lawyer,created_by=request.user,assignee=req_assignee_user)
            hearings.save()
