...
class PathSerializer(serializers.ModelSerializer):
    ...
    def get_case_name(self, obj):
        return self.get_cached_related_name(obj, LitigationCases, "case_id", "case","name")

    def get_admin_name(self, obj):
        return self.get_cached_related_name(obj, AdministrativeInvestigation, "admin_id", "admin","subject")

    def get_notation_name(self, obj):
        return self.get_cached_related_name(obj, Notation, "notation_id", "notation","subject")

    def get_folder_name(self, obj):
        return self.get_cached_related_name(obj, Folder, "folder_id", "folder","name")

    def get_contract_name(self, obj):
        return self.get_cached_related_name(obj, Contract, "contract_id", "contract","name")
