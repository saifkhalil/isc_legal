...
class LitigationCasesAdmin(ImportExportModelAdmin,admin.ModelAdmin):
    ...
    fields = ( 'name','description','case_category','judge','tasks','comments','detective','ImportantDevelopment','case_type','case_status','court','documents','client_position','opponent_position','assignee','shared_with','priority','end_time','start_time','is_deleted','created_by','created_at','modified_by','modified_at')
...
class FoldersAdmin(ImportExportModelAdmin,admin.ModelAdmin):
    list_display = ('id', 'name','description','is_deleted')
    fields = ( 'name','description','folder_category','judge','tasks','comments','detective','ImportantDevelopment','folder_type','court','documents','client_position','opponent_position','assignee','shared_with','priority','end_time','start_time','is_deleted','created_by','created_at','modified_by','modified_at')
    readonly_fields = ('created_by','created_at','modified_by','modified_at')
