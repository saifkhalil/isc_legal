...
from .models import LitigationCases, stages, client_position, opponent_position, case_type, court, LitigationCasesEvent, \
    Folder, ImportantDevelopment
...
class LitigationCasesSerializer(DynamicFieldsMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'description', 'case_category', 'priority', 'shared_with', 'court',
                  ...
                  'paths', 'hearing', 'start_time', 'end_time', 'created_by', 'created_at']
