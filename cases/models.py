...
from activities.models import task, hearing,event
...
class practice_area(TranslatableModel):
...
class companies_category(models.Model):
    id = models.AutoField(primary_key=True,)
    category = models.CharField(max_length=250, blank=False, null=False,verbose_name=_('Category'))
...
class LitigationCases(models.Model):
    ...
    description   = models.CharField(max_length=500, blank=False, null=False, verbose_name=_('Subject'))
    ...
    practice_area = models.ForeignKey('practice_area', on_delete=models.CASCADE, blank=True,null=True, verbose_name=_('Practice area'))
