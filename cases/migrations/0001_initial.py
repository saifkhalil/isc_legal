...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('cid', models.CharField(blank=True, editable=False, max_length=20, null=True, verbose_name='Case ID')),
                ...
                ('filed_on', models.DateField(blank=True, null=True, verbose_name='Filed on')),
                ...
                ('assigned_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='auth.group', verbose_name='Assigned Team')),
                ...
                ('case_status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_case_status', to='cases.case_status', verbose_name='Case Status')),
                ...
                ('practice_area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cases.practice_area', verbose_name='Practice area')),
                ...
                ('requested_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_requested_by', to=settings.AUTH_USER_MODEL, verbose_name='Requested By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(blank=True, default='IQ', max_length=2, null=True, verbose_name='Country')),
